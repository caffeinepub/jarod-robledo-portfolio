...
import type { Category as _Category, ExternalBlob as _ExternalBlob, Photo as _Photo, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async reorderPhoto(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        order: value.order,
        blobKey: await from_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.blobKey),
